<section class="c-inicio">
    ...
    <?php
        ...
        if (Sesion::estaLogeado() && RepositorioConcurso::participanteEstaInscrito($concurso->getId(),Sesion::leer('usuario')->getId())) {
            ...
            $boton = '<span class="c-boton c-boton--secundario"><a href="./?menu=concursos&idConcurso='.$concurso->getId().'&accion=inscribe">Incribirse</a></span>'
                    .'<span class=""><a href="./?menu=verConcurso&id='.$concurso->getId().'">Ver concurso</a></span>';
        }
